...
- Add forecast-date automation that derives projected completion dates from rolled-up estimate hours and configured capacity calendars.
...
- `projects-forecast-date-automation`: Derives and updates forecast dates from rolled-up estimate hours and capacity inputs.
