...
The system SHALL derive forecast completion date from rolled-up estimate hours using configured capacity calendars and working-day rules.
...
- **WHEN** rolled-up estimate hours require work across a weekend and weekend days are non-working
