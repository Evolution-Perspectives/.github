...
- Derive forecast completion dates from rolled-up estimate hours and capacity settings.
...
- Which project fields are canonical for estimate hours across all target boards?
